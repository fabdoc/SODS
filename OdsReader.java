...
import com.github.miachm.sods.Style.TEXT_POSITION;
    ...
    private Style readCellStyleEntry(XmlReaderInstance reader) {
        ...
        while (reader.hasNext()) {
            ...
            if(instance.getTag().equals("style:paragraph-properties")) {
            	...
            	if(align != null) {
            		TEXT_POSITION pos = null;
            		if(align.equals(TEXT_POSITION.Center.toString().toLowerCase())) {
            			pos = TEXT_POSITION.Center;
            		}
            		else if(align.equals("end")) {
            			pos = TEXT_POSITION.Right;
            		}
            		else if(align.equals("start")) {
            			pos = TEXT_POSITION.Left;
            		}
            		style.setTextPosition(pos);
            	}
            }
        }
        return style;
